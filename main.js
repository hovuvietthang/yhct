...
fetch(postAPI) 
  ...
  .then(function(post){
    ...
    $(document).ready(function(){
      ...
      //  console.log(post[IdNum].ten_huyet);
      //  console.log(post[IdNum].ky_hieu);
      //  console.log(post[IdNum].y_nghia);
      //  console.log(post[IdNum].duong_kinh);
      //  console.log(post[IdNum].tac_dung);
      //  console.log(post[IdNum].chu_tri);
